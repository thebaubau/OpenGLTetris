// TODO:
// - Try out new char sizes and pixel sizes. See if shader uniforms can do anything
// - Check glTexImage2D different formats
// - glPixelStorei different values if format is not only one byte
